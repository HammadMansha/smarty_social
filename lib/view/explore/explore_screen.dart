  ...
  bodyData(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: RefreshIndicator(
        ...
        child:    Obx(() {
            return exploreController.isLoading.value==true?const AppLoader(): Column(
              children: [
                const SizedBox(
                  height: 30,
                ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        //Follow button
                                       feed.userId!=exploreController.myUserId? GestureDetector(
                                         onTap:()async{
                                            ...
                                            child: Row(
                                              children: [
                                                SizedBox(
                                                  child: Obx(() {
                                                    return GestureDetector(
                                                      onTap: ()=>exploreController.likeValue(index),
                                                      child: Icon(
                                                        exploreController.likedList[
                                                                    index] ==
                                                                true
                                                            ? Icons.favorite
